...
export const MiniPitch: React.FC<MiniPitchProps> = ({ 
  ...
  return (
    <div className="relative w-full aspect-[105/68] bg-[#428042] rounded border border-[#1a1a1a] overflow-hidden shadow-2xl select-none">
      <svg 
        viewBox="0 0 105 68" 
      ...
      >
        {/* Pitch markings */}
        <g stroke="rgba(255,255,255,0.7)" strokeWidth="0.6" fill="none" className="pointer-events-none">
          ...
          return (
            ...
            >
              ...
              <rect 
                ...
                height="5" 
                rx={isCustom ? "2.5" : "1.5"}
                fill={isActive ? "#ffdf00" : isMapped ? "#4ade80" : isCustom ? "rgba(255, 255, 255, 0.4)" : "rgba(20, 20, 20, 0.6)"}
                ...
                style={{ 
                  filter: isActive ? 'drop-shadow(0px 0px 3px rgba(255,223,0,0.8))' : 'drop-shadow(0px 1px 2px rgba(0,0,0,0.4))',
                  transformOrigin: 'center',
                  transformBox: 'fill-box'
                }}
              />
      ...
      <div className="absolute bottom-1 left-1 pointer-events-none">
        <span className="text-[8px] text-white/40 uppercase font-bold bg-black/20 px-1 rounded">Click pitch to add custom point</span>
      </div>
    </div>
  );
};
